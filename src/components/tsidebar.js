...
import plogo from "./static/logo-5.png";
    ...
    <>
      ...
      >
              ...
              >
                <div
                  className={`shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5  ${
                    isact === 1 &&
                    "bg-gradient-to-tl from-blue-700 to-yellow-500"
                  }`}
                >
                  <HomeRoundedIcon
        ...
        <div className="mx-4">
          ...
          <button
            className="inline-block w-full px-6 py-3 my-4 font-bold text-center text-white uppercase align-middle transition-all ease-in border-0 rounded-lg select-none shadow-soft-md bg-150 bg-x-25 leading-pro text-xs bg-gradient-to-tl from-blue-500 to-yellow-500 hover:shadow-soft-2xl hover:scale-102"
            onClick={logout}
          >
            Sign Out
          </button>
